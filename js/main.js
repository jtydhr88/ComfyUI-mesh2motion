...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    function handleMessage(event) {
      var _a;
      if (event.source !== ((_a = iframeRef.value) == null ? void 0 : _a.contentWindow)) {
        return;
      }
      ...
      switch (type) {
        ...
        case "mesh2motion:export":
          if ((data3 == null ? void 0 : data3.modelData) && (data3 == null ? void 0 : data3.filename)) {
            emit2("save", data3.modelData, data3.filename);
          }
          break;
        ...
        case "mesh2motion:error":
          console.error("[Mesh2Motion] Error:", data3 == null ? void 0 : data3.message);
          break;
      }
    }
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    onMounted(() => {
      var _a, _b;
      const colorPalette = ((_b = (_a = app.ui) == null ? void 0 : _a.settings) == null ? void 0 : _b.getSettingValue("Comfy.ColorPalette")) || "";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(script), {
        ...
        default: withCtx(() => [
          visible.value ? (openBlock(), createBlock(Mesh2MotionEditor, {
            key: 0,
            ref_key: "mesh2motionEditorRef",
...
const dialog$1 = { "title": "Mesh2Motion 3D Editor", "save": "Save to ComfyUI", "cancel": "Cancel", "saveSuccess": "Model saved successfully", "saveFailed": "Failed to save model" };
const editor$1 = { "loading": "Loading Mesh2Motion editor...", "noModel": "No 3D model loaded. Upload a model to get started.", "exportFailed": "Failed to export model" };
const menu$1 = { "openEditor": "Open in Mesh2Motion" };
const en = {
  dialog: dialog$1,
  editor: editor$1,
  menu: menu$1
};
const dialog = { "title": "Mesh2Motion 3D 编辑器", "save": "保存到 ComfyUI", "cancel": "取消", "saveSuccess": "模型保存成功", "saveFailed": "保存模型失败" };
const editor = { "loading": "正在加载 Mesh2Motion 编辑器...", "noModel": "未加载3D模型。上传模型以开始。", "exportFailed": "导出模型失败" };
const menu = { "openEditor": "在 Mesh2Motion 中打开" };
const zh = {
  dialog,
  editor,
  menu
...
function isModel3DNode(node) {
  ...
  if (n.widgets) {
    const has3DWidget = n.widgets.some(
      (w2) => w2.name === "model_file" || w2.name === "mesh" || w2.name === "3d_model" || w2.value && typeof w2.value === "string" && /\.(glb|gltf|fbx|obj)$/i.test(w2.value)
    );
...
function ensureMesh2MotionInstance() {
  if (rootInstance) {
    return rootInstance;
  }
